...
#       use BaseEvent v* DataModel (no_version_directory)
#       use EDMUtil v* DataModel (no_version_directory)
#     use ClusterInfoEvent v* DataModel/ClusterInfo (no_version_directory)
#       use ROOT v* Externals (no_version_directory)
#       use BaseEvent v* DataModel (no_version_directory)
#       use EDMUtil v* DataModel (no_version_directory)
#     use ClusterInfoSvc v* DataModel/ClusterInfo (no_version_directory)
#       use SniperKernel v*  (no_version_directory)
#       use ROOT v* Externals (no_version_directory)
#       use Boost v* Externals (no_version_directory)
#       use CalibEvent v* DataModel (no_version_directory)
...
use Context v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use JunoTest v0 Validation (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use XmlObjDesc v0  (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline) (no_auto_imports)
use CLHEPDict v0 DataModel/Dict (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use BaseEvent v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use SniperKernel v2  (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre1/sniper)
use Identifier v0 Detector (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use Geometry v0 Detector (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use EDMUtil v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use PhyEvent v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use DataRegistritionSvc v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use ClusterInfoEvent v0 DataModel/ClusterInfo (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use CalibEvent v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use ElecEvent v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use GenEventV2 v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use RecEvent v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use SimEventV2 v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use EvtNavigator v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use ClusterInfoSvc v0 DataModel/ClusterInfo (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use DataModelRelease v0 DataModel (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use RootIOUtil v0 RootIO (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use RootIOSvc v0 RootIO (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use RootIOTools v0 RootIO (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use BufferMemMgr v0 CommonSvc (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
use RootIOTest v0 RootIO (/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline)
----------> tags
...
----------> CMTPATH
# Add path /afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7_v2/offline from initialization
