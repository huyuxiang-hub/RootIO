...
#cmt_local_tagfile_install_more_includes = $(RootIOTools_tag)_install_more_includes.make
cmt_local_tagfile_install_more_includes = $(bin)$(RootIOTools_tag)_install_more_includes.make
...
#cmt_local_tagfile_install_more_includes = $(RootIOTools_tag).make
cmt_local_tagfile_install_more_includes = $(bin)$(RootIOTools_tag).make
...
#cmt_final_setup_install_more_includes = $(bin)RootIOTools_install_more_includessetup.make
...
#cmt_final_setup_install_more_includes = $(bin)RootIOToolssetup.make
cmt_local_install_more_includes_makefile = $(bin)install_more_includes.make
...
$(install_include_dir) ::
	@if test "$(installarea)" = ""; then \
	  ...
	  if test ! "RootIOTools" = ""; then \
	    if test -d ../RootIOTools; then \
	      echo "Installing files from more ../RootIOTools to $(install_include_dir)"; \
	      if test ! -d $(install_include_dir) ; then mkdir -p $(install_include_dir); fi; \
	      if test ! -d $(install_include_dir)/RootIOTools; then mkdir -p $(install_include_dir)/RootIOTools; fi;\
	        $(install_command) ../RootIOTools $(install_include_dir);\
	    else \
	      echo "No more RootIOTools include directory"; \
	    fi; \
          fi; \
	fi
...
install_more_includesuninstall ::
	@if test "$(installarea)" = ""; then \
	  ...
	  echo "Uninstalling files from $(install_include_dir)/RootIOTools"; \
	  $(uninstall_command) "$(install_include_dir)/RootIOTools/*" ; \
	  if test -f $(install_include_dir)/RootIOTools.cmtref ; then \
	    echo "Removing $(install_include_dir)/RootIOTools.cmtref"; \
	    eval rm -f $(install_include_dir)/RootIOTools.cmtref ; \
	  fi; \
	fi
