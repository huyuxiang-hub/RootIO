...
#  Library RootIOTools
#
#   Generated Tue Dec  1 16:05:54 2020  by huyuxiang
#
#====================================
...
RootIOToolscompile : $(bin)UniqueIDTableMerger.o $(bin)FileMetaDataMerger.o $(bin)MergingInputSvc.o $(bin)MergeRootFilesAlg.o $(bin)TreeLooper.o $(bin)SimEventMerger.o ;
...
$(RootIOToolslib) :: $(bin)UniqueIDTableMerger.o $(bin)FileMetaDataMerger.o $(bin)MergingInputSvc.o $(bin)MergeRootFilesAlg.o $(bin)TreeLooper.o $(bin)SimEventMerger.o
	$(lib_echo) "static library $@"
	$(lib_silent) [ ! -f $@ ] || \rm -f $@
	$(lib_silent) $(ar) $(RootIOToolslib) $(bin)UniqueIDTableMerger.o $(bin)FileMetaDataMerger.o $(bin)MergingInputSvc.o $(bin)MergeRootFilesAlg.o $(bin)TreeLooper.o $(bin)SimEventMerger.o
...
RootIOToolsclean ::
	...
	$(cleanup_silent) /bin/rm -f $(bin)UniqueIDTableMerger.o $(bin)FileMetaDataMerger.o $(bin)MergingInputSvc.o $(bin)MergeRootFilesAlg.o $(bin)TreeLooper.o $(bin)SimEventMerger.o
	$(cleanup_silent) /bin/rm -f $(patsubst %.o,%.d,$(bin)UniqueIDTableMerger.o $(bin)FileMetaDataMerger.o $(bin)MergingInputSvc.o $(bin)MergeRootFilesAlg.o $(bin)TreeLooper.o $(bin)SimEventMerger.o) $(patsubst %.o,%.dep,$(bin)UniqueIDTableMerger.o $(bin)FileMetaDataMerger.o $(bin)MergingInputSvc.o $(bin)MergeRootFilesAlg.o $(bin)TreeLooper.o $(bin)SimEventMerger.o) $(patsubst %.o,%.d.stamp,$(bin)UniqueIDTableMerger.o $(bin)FileMetaDataMerger.o $(bin)MergingInputSvc.o $(bin)MergeRootFilesAlg.o $(bin)TreeLooper.o $(bin)SimEventMerger.o)
...
$(bin)RootIOTools_dependencies.make : $(use_requirements) $(cmt_final_setup_RootIOTools)
	$(echo) "(RootIOTools.make) Rebuilding $@"; \
	  $(build_dependencies) -out=$@ -start_all $(src)UniqueIDTableMerger.cc $(src)FileMetaDataMerger.cc $(src)MergingInputSvc.cc $(src)MergeRootFilesAlg.cc $(src)TreeLooper.cc $(src)SimEventMerger.cc -end_all $(includes) $(app_RootIOTools_cppflags) $(lib_RootIOTools_cppflags) -name=RootIOTools $? -f=$(cmt_dependencies_in_RootIOTools) -without_cmt
...
ifneq ($(MAKECMDGOALS),RootIOToolsclean)
ifneq ($(MAKECMDGOALS),uninstall)
-include $(bin)$(binobj)MergingInputSvc.d

$(bin)$(binobj)MergingInputSvc.d :

$(bin)$(binobj)MergingInputSvc.o : $(cmt_final_setup_RootIOTools)

$(bin)$(binobj)MergingInputSvc.o : $(src)MergingInputSvc.cc
	$(cpp_echo) $(src)MergingInputSvc.cc
	$(cpp_silent) $(cppcomp)  -o $@ $(use_pp_cppflags) $(RootIOTools_pp_cppflags) $(lib_RootIOTools_pp_cppflags) $(MergingInputSvc_pp_cppflags) $(use_cppflags) $(RootIOTools_cppflags) $(lib_RootIOTools_cppflags) $(MergingInputSvc_cppflags) $(MergingInputSvc_cc_cppflags)  $(src)MergingInputSvc.cc
endif
endif

else
$(bin)RootIOTools_dependencies.make : $(MergingInputSvc_cc_dependencies)

$(bin)RootIOTools_dependencies.make : $(src)MergingInputSvc.cc

$(bin)$(binobj)MergingInputSvc.o : $(MergingInputSvc_cc_dependencies)
	$(cpp_echo) $(src)MergingInputSvc.cc
	$(cpp_silent) $(cppcomp) -o $@ $(use_pp_cppflags) $(RootIOTools_pp_cppflags) $(lib_RootIOTools_pp_cppflags) $(MergingInputSvc_pp_cppflags) $(use_cppflags) $(RootIOTools_cppflags) $(lib_RootIOTools_cppflags) $(MergingInputSvc_cppflags) $(MergingInputSvc_cc_cppflags)  $(src)MergingInputSvc.cc
...
ifneq ($(MAKECMDGOALS),RootIOToolsclean)
ifneq ($(MAKECMDGOALS),uninstall)
-include $(bin)$(binobj)SimEventMerger.d

$(bin)$(binobj)SimEventMerger.d :

$(bin)$(binobj)SimEventMerger.o : $(cmt_final_setup_RootIOTools)

$(bin)$(binobj)SimEventMerger.o : $(src)SimEventMerger.cc
	$(cpp_echo) $(src)SimEventMerger.cc
	$(cpp_silent) $(cppcomp)  -o $@ $(use_pp_cppflags) $(RootIOTools_pp_cppflags) $(lib_RootIOTools_pp_cppflags) $(SimEventMerger_pp_cppflags) $(use_cppflags) $(RootIOTools_cppflags) $(lib_RootIOTools_cppflags) $(SimEventMerger_cppflags) $(SimEventMerger_cc_cppflags)  $(src)SimEventMerger.cc
endif
endif

else
$(bin)RootIOTools_dependencies.make : $(SimEventMerger_cc_dependencies)

$(bin)RootIOTools_dependencies.make : $(src)SimEventMerger.cc

$(bin)$(binobj)SimEventMerger.o : $(SimEventMerger_cc_dependencies)
	$(cpp_echo) $(src)SimEventMerger.cc
	$(cpp_silent) $(cppcomp) -o $@ $(use_pp_cppflags) $(RootIOTools_pp_cppflags) $(lib_RootIOTools_pp_cppflags) $(SimEventMerger_pp_cppflags) $(use_cppflags) $(RootIOTools_cppflags) $(lib_RootIOTools_cppflags) $(SimEventMerger_cppflags) $(SimEventMerger_cc_cppflags)  $(src)SimEventMerger.cc
